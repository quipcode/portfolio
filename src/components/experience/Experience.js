    ...
    return(
        ...
        <VerticalTimeline className="timeline-classy">
            <VerticalTimelineElement
                ...
                contentStyle={{ background: 'rgb(33, 150, 243)', "color": '#fff', backgroundImage: `url(${Background1})`, "background-size": "contain" , "background-repeat": "no-repeat"}}
            ...
            <VerticalTimelineElement
                ...
                contentStyle={{ background: 'rgb(33, 150, 243)', "color": '#fff', backgroundImage: `url(${Background2})`, "background-size": "contain" , "background-repeat": "no-repeat", "background-position": "right"}}
                date="2010 - 2011"
                iconStyle={{ background: 'rgb(33, 150, 243)', color: '#fff' }}
                ////icon={<WorkIcon />}
            >
